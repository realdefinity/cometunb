  ...
  const openShop = () => {
    ...
    panel.innerHTML = `
      <div class="shop-header">
        ...
        <button type="button" class="btn-icon shop-close" aria-label="Close shop dialog">✕</button>
      </div>
    ...
    const firstFocusable = panel.querySelector('.shop-item:not(.disabled), button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');
