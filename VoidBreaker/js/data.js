window.WEAPONS = {
    ...
    crossbow: { name: 'Crossbow', damage: 45, cooldown: 45, speed: 22, spread: 0.02, count: 1, pierce: 2, color: '#38bdf8', rarity: 'rare', desc: 'Powerful bolts that pierce.', price: 2000 },
    sniper: { name: 'Sniper', damage: 90, cooldown: 70, speed: 25, spread: 0.01, count: 1, pierce: 4, color: '#38bdf8', rarity: 'rare', desc: 'Pierces multiple targets.', price: 2000 },
    blaster: { name: 'Blaster', damage: 35, cooldown: 15, speed: 10, spread: 0.05, count: 1, pierce: 1, color: '#38bdf8', rarity: 'rare', desc: 'Energy projectiles.', price: 2000 },
    flak: { name: 'Flak Gun', damage: 25, cooldown: 40, speed: 12, spread: 0.2, count: 3, pierce: 1, color: '#38bdf8', rarity: 'rare', desc: 'Wide spread shot.', price: 2000 },
    grenade: { name: 'Grenade Launcher', damage: 60, cooldown: 50, speed: 10, spread: 0.1, count: 1, pierce: 0, color: '#38bdf8', rarity: 'rare', desc: 'Explosive grenades.', price: 2000 },
    minigun: { name: 'Minigun', damage: 15, cooldown: 2, speed: 18, spread: 0.3, count: 1, pierce: 1, color: '#a855f7', rarity: 'epic', desc: 'Rapid fire spray.', price: 5000 },
    laser: { name: 'Laser', damage: 15, cooldown: 1, speed: 30, spread: 0, count: 1, pierce: 0, color: '#a855f7', rarity: 'epic', desc: 'Continuous beam.', price: 5000 },
    launcher: { name: 'Rocket Launcher', damage: 100, cooldown: 90, speed: 8, spread: 0.1, count: 1, pierce: 0, color: '#a855f7', rarity: 'epic', desc: 'Big explosive rounds.', price: 5000 },
    spreader: { name: 'Spreader', damage: 18, cooldown: 15, speed: 12, spread: 0.6, count: 7, pierce: 0, color: '#a855f7', rarity: 'epic', desc: 'Fans out many shots.', price: 5000 },
    hydra: { name: 'Hydra', damage: 40, cooldown: 10, speed: 15, spread: 0.5, count: 5, pierce: 2, color: '#fbbf24', rarity: 'legendary', desc: 'Shotgun on rapid fire.', price: 10000 },
    void_cannon: { name: 'Void Cannon', damage: 500, cooldown: 120, speed: 5, spread: 0, count: 1, pierce: 99, color: '#fbbf24', rarity: 'legendary', desc: 'Clears a path.', price: 10000 },
    arc_caster: { name: 'Arc Caster', damage: 5, cooldown: 1, speed: 20, spread: 360, count: 8, pierce: 0, color: '#fbbf24', rarity: 'legendary', desc: 'Shoots in all directions.', price: 10000 },
    railgun: { name: 'Railgun', damage: 120, cooldown: 60, speed: 35, spread: 0, count: 1, pierce: 6, color: '#fbbf24', rarity: 'legendary', desc: 'Ultra fast piercing shot.', price: 10000 }
};

window.UPGRADES_DB = [
    { id: 'dmg', name: 'Damage', desc: '+15% Damage', rarity: 'common', weight: 100, max: 10, type: 'stat', stat: 'damage', val: 1.15 },
    { id: 'rate', name: 'Fire Rate', desc: '+10% Fire Rate', rarity: 'common', weight: 100, max: 10, type: 'stat', stat: 'cooldown', val: 0.9 },
    { id: 'speed', name: 'Speed', desc: '+8% Move Speed', rarity: 'common', weight: 100, max: 8, type: 'stat', stat: 'maxSpeed', val: 1.08 },
    { id: 'hp', name: 'Health', desc: '+25 Max HP', rarity: 'common', weight: 80, max: 10, type: 'heal', val: 25 },
    { id: 'mag', name: 'Pickup Range', desc: '+25% Pickup Range', rarity: 'common', weight: 80, max: 5, type: 'stat', stat: 'pickupRange', val: 1.25 },
    { id: 'pierce', name: 'Pierce', desc: '+1 Pierce', rarity: 'rare', weight: 40, minWave: 2, max: 3, type: 'add', stat: 'pierce', val: 1 },
    { id: 'multi', name: 'Multi-Shot', desc: '+1 Projectile', rarity: 'rare', weight: 40, minWave: 3, max: 3, type: 'add', stat: 'count', val: 1 },
    { id: 'regen', name: 'Regen', desc: '+1 HP per second', rarity: 'rare', weight: 30, minWave: 2, max: 5, type: 'add', stat: 'regen', val: 1 },
    { id: 'crit', name: 'Crit Chance', desc: '+10% Crit Chance', rarity: 'rare', weight: 30, minWave: 2, max: 5, type: 'add', stat: 'critChance', val: 0.1 },
    { id: 'backshot', name: 'Back Shot', desc: 'Shoot 1 bullet backwards', rarity: 'rare', weight: 25, minWave: 4, max: 1, type: 'bool', stat: 'backshot' },
    { id: 'bounce', name: 'Bounce', desc: 'Bullets bounce off walls', rarity: 'epic', weight: 10, minWave: 5, max: 1, type: 'bool', stat: 'ricochet' },
    { id: 'homing', name: 'Homing', desc: 'Bullets seek enemies', rarity: 'epic', weight: 10, minWave: 6, max: 1, type: 'bool', stat: 'homing' },
    { id: 'explode', name: 'Explode', desc: 'Enemies explode on death', rarity: 'epic', weight: 10, minWave: 5, max: 1, type: 'bool', stat: 'explosive' },
    { id: 'dash_nova', name: 'Dash Blast', desc: 'Dashing releases explosion', rarity: 'epic', weight: 10, minWave: 4, max: 1, type: 'bool', stat: 'dashNova' },
    { id: 'vamp', name: 'Lifesteal', desc: '5% Lifesteal on hit', rarity: 'epic', weight: 10, minWave: 5, max: 3, type: 'add', stat: 'lifesteal', val: 0.05 },
    { id: 'tesla', name: 'Lightning', desc: 'Zaps nearby enemies', rarity: 'legendary', weight: 2, minWave: 8, max: 1, type: 'bool', stat: 'tesla' },
    { id: 'freeze', name: 'Freeze', desc: 'Slows enemies by 50%', rarity: 'legendary', weight: 2, minWave: 8, max: 1, type: 'bool', stat: 'freeze' },
    { id: 'god_mode', name: 'Tank', desc: '+200 HP, +2 Pierce', rarity: 'legendary', weight: 1, minWave: 10, max: 1, type: 'complex', apply: (p) => { p.maxHp += 200; p.hp += 200; p.pierce += 2; } },
